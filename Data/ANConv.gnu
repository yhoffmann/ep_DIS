...
plot 'FirstOrderResultsAnalyticalVsNumericalConv0.txt' u 2:($4/$6) lw 2 w lines title "sqrt(10)"
replot 'FirstOrderResultsAnalyticalVsNumericalConv1.txt' u 2:($4/$6) lw 2 w lines title "sqrt(20)"
replot 'FirstOrderResultsAnalyticalVsNumericalConv2.txt' u 2:($4/$6) lw 2 w lines title "sqrt(40)"
replot 'FirstOrderResultsAnalyticalVsNumericalConv3.txt' u 2:($4/$6) lw 2 w lines title "sqrt(80)"
