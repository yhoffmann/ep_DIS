...
set xlabel "|{/Symbol D}|"
set ylabel "d{/Symbol s}/dt-longitudinal [nbGeV^{-1}]"
...
plot [] for [IDX=0:15] 'FirstOrderResultsAnalyticalVsNumerical.txt' i IDX u 2:($4/$6) lw 2 w lines title columnheader(1)
